...
export default class HelloWorld extends React.Component < IHelloWorldProps, {} > {
  ...
  protected showNotifications(): void {
    ...
    toastr.info("Please select user", "No user selected");
    toastr.success("Please select user", "No user selected");
    toastr.warning("Please select user", "No user selected");
    toastr.error("Please select user", "No user selected");
  ...
  protected init(): void {
    ...
    console.log("Initialize..");
      ...
      console.log("Third-party js/css loaded.");
